# iniial script to grab data out of reports and create files per CVE for later use

# look at the CSV -> get the CVE -> create a file



# helper function to search the data store for a given CVE and grab the data we need
# can be flexible to help with future needs

create a python function that searches a JSON file for a given CVE ID and returns the relevant data. The JSON file is structured as a list of dictionaries, each containing CVE data as shown below. For the searched CVE ID, return the following fields:
The CVE description in "cve" : "descriptions"
The CVE vendor CVSS v4.0 metric string in "cve" : cvssMetricV40 vectorString where source is vendor and type is secondary
The CVE vendor CVSS v3.1 metric string in "cve" : cvssMetricV31 vectorString where source is vendor and type is secondary
The NVD CVSS v3.1 "cve" : cvssMetricV31 vectorString where source is NVD and type is primary
The CWE value in "weaknesses" : value" such as "CWE-93"

{
    "cve" : {
      ...
      "lastModified" : "2026-01-06T18:20:44.533",
      "vulnStatus" : "Analyzed",
      "cveTags" : [ ],
      "descriptions" : [ {
        "lang" : "en",
      ...
      "configurations" : [ {
        "nodes" : [ {
          ...
          "cpeMatch" : [ {
            ...
            "matchCriteriaId" : "884C94CD-B632-4081-9141-BB0FBFE2516E"
          } ]
        } ]
      } ],
      "references" : [ {
